...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('Fantabulous star', starId2, {from: user2});
    await instance.approve(user2, starId1, {from: user1, gasPrice: 0});
    await instance.approve(user1, starId2, {from: user2, gasPrice: 0});
    await instance.exchangeStars(starId2, starId1, {from: user1, gasPrice: 0});
